...
if((peso1 <55 || peso2 <55) && (peso1 >=55 || peso2 >=55)){ //se um for menor e o outro for maior
    return ("NÃO PODEM LUTAR");

}else if((peso1 >= 55 && peso1 < 65) && (peso2 >= 55 && peso2 >=65)){ // se ambos estiverem dentro da faixa de peso
    return ("PODEM JOGAR");

}else if((peso1 >=65 && peso1 < 75)&& (peso2 >=65 && peso2>75)){ // se ambos estiverem na mesma faixa de peso
    return("PODEM JOGAR")

}else if((peso1 >=75 && peso1 <85) && (peso2 >=75 && peso2 <85)){ // se ambos estiverem na mesma faixa de peso
    return("PODEM JOGAR")

}else if((peso1>= 85 && peso2 >=85)){ // se ambos forem maior ou igual a 85 kg
    return("PODEM JOGAR")

} else {
    return("NÃO PODEM JOGAR")
} 
