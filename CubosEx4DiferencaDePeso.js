let diferencaDePeso = peso1[55] - peso2[60]; // está subtraindo o peso do jogar A do peso do jogador B

if (diferencaDePeso <= 5 && diferencaDePeso >= -5){ // verifica se a diferença de peso está entre -5 e 5
    return("PODEM LUTAR");
